...
const COLLECTIONS = [
  {
    id: 1,
    name: "Escapada Tropical",
    tagline: "Estampados exclusivos que atraerán todas las miradas a tu escaparate.",
    pieces: "42 Styles",
    img: ASSETS.resort,
    tag: "TENDENCIA VERANO",
  },
  {
    id: 2,
    name: "Elegancia Urbana",
    tagline: "Piezas estructuradas en denim para la clienta moderna y sofisticada.",
    pieces: "38 Styles",
    img: ASSETS.denim,
    tag: "COLECCIÓN CORE",
  },
  {
    ...
    tagline: "Texturas ligeras y femeninas que tus clientas comprarán temporada tras temporada.",
    pieces: "55 Styles",
  ...
  {
    id: 4,
    name: "Sastrería de Autor",
    tagline: "Innovación en mezclilla para clientas que buscan piezas únicas y diferenciadoras.",
    pieces: "45 Styles",
  ...
  },
  {
    ...
    tagline: "Tejidos premium ligeros, ideales para transiciones de temporada.",
    pieces: "38 Styles",
    ...
    tag: "COLECCIÓN CRUCERO",
  },
  {
    id: 6,
    name: "Monocromático Chic",
    tagline: "Sofisticación sin esfuerzo en tonos pastel que dominan las tendencias.",
    pieces: "32 Styles",
